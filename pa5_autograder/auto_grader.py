...
def file_grade(dirname):
	...
	#continue
	    ...
	    print "Now testing " + dirname + " on " + testfile
            run_command("./%s %s >> %s"%(dirname, test_dir + testfile, resultfile), timeout=runtime[dirname], user_program=True);
...
if __name__ == '__main__':
    ...
    print "Your TOTAL SCORE = ", Total_score, "/100.0 for the public test cases"
